...
def psi_linear_system_noalpha(parset,x, verbose=False, return_out=False):
    c1,c2,c3_,c4,c7_,c8_,ke,kes,kis,kisr_=parset
    alpha0=1
    delta=1
    c7=c1*c7_
    c8=c2*c8_
...
def psi_linear_system_noalpha_lessparsv1(parset,x, verbose=False, return_out=False):
    c2,c4,c7_,ke,kes,kis=parset
    alpha0=1
    delta=1
    c1=1
    c3_=1
